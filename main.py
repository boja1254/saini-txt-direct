...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/+CislpaPc27AyOGVl"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+CislpaPc27AyOGVl"),
        ],
    ]
)
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        "🎉Congrats! You are using 『TG』 ཌMÉØUJKད°°ツ:\n┣\n"
...
BUTTONS = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url=f"https://t.me/+CislpaPc27AyOGVl")]])
...
async def txt_handler(bot: Client, m: Message):
    ...
    await m.reply_text(f"`✨𝙱𝚊𝚝𝚌𝚑 𝚂𝚞𝚖𝚖𝚊𝚛𝚢✨\n"
                       ...
                       f"✅𝚂𝚝𝚊𝚝𝚞𝚜 » 𝙲𝚘𝚖𝚙𝚕𝚎𝚝𝚎𝚍`")
    await m.reply_text("<pre><code>Downloaded By ⌈✨『『TG』 ཌMÉØUJKད°°ツ』✨⌋</code></pre>")
...
async def txt_handler(bot: Client, m: Message):
    ...
    try: 
        for i in range(arg-1, len(links)):
            ...
            try:  
                ...
                if ".pdf" in url or "drive" in url or ".jpg" in url or ".jpeg" in url or ".png" in url:
                    try:
                        await m.reply_text(text=f'——— ✨ [{str(count).zfill(3)}]({link0}) ✨ ———\n\n📔𝐓𝐢𝐭𝐥𝐞 » `{name}`\n\n✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ `『TG』 ཌMÉØUJKད°°ツ🐦`', disable_web_page_preview=True, reply_markup=BUTTONSDOC)
                        count +=1
                    except Exception as e:
                        await m.reply_text(str(e))    
                        time.sleep(3)    
                    ...
                    try:
                        await m.reply_text(text=f'——— ✨ [{str(count).zfill(3)}]({link0}) ✨ ———\n\n📔𝐓𝐢𝐭𝐥𝐞 » `{name}`\n\n✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ `『TG』 ཌMÉØUJKད°°ツ🐦`', disable_web_page_preview=True, reply_markup=BUTTONSCP)
                        count +=1
                    except Exception as e:
                        await m.reply_text(str(e))    
                        time.sleep(3)    
                    ...
                    try:
                        await m.reply_text(text=f'——— ✨ [{str(count).zfill(3)}]({link0}) ✨ ———\n\n📔𝐓𝐢𝐭𝐥𝐞 » `{name}`\n\n✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ `『TG』 ཌMÉØUJKད°°ツ🐦`', disable_web_page_preview=True, reply_markup=BUTTONSYT)
                        count +=1
                    except Exception as e:
                        await m.reply_text(str(e))    
                        time.sleep(3)    
                    ...
                    Show = f"<pre><code>⚡Dᴏᴡɴʟᴏᴀᴅ Sᴛᴀʀᴛᴇᴅ...⏳\n✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ 『TG』 ཌMÉØUJKད°°ツ🐦</code></pre>"
                    prog = await m.reply_text(Show, disable_web_page_preview=True)
                    res_file = await helper.download_video(url, cmd, name)
                    filename = res_file
                    await prog.delete(True)
                ...
                await m.reply_text(text=f'——— ✨ [{str(count).zfill(3)}]({link0}) ✨ ———\n\n📔𝐓𝐢𝐭𝐥𝐞 » `{name}`\n\n✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ `『TG』 ཌMÉØUJKད°°ツ🐦`', disable_web_page_preview=True, reply_markup=BUTTONSMAN)
                count += 1
                time.sleep(3)
                continue
        ...
        await m.reply_text(e)
    await m.reply_text("<pre><code>Converted By ⌈✨『『TG』 ཌMÉØUJKད°°ツ』✨⌋</code></pre>")
